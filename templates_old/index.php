	...
	<div class="ImgWrap Home" style="background-image:url('<?php echo $BaseUrl.'/uploads/'.$PageImg; ?>')">
		<div class="Row Visible">
			<div class="FilterBlockWrap">
				<div class="BorderSpace FilterSpace">
									...
									<div class="FilterCol Right">
										<div class="FilterRight">
											...
											<?php 
												...
												$FilterUrl = 'probleem_melden/'.$FilterUrl;
											?>
...
END;
												...
												while($FilterRow = $FilterResult->fetch_array()){
													...
													$OptionUrl = 'probleem_melden/'.$OptionUrl;
...
END;
											...
											<a href="<?php echo $FilterUrl; ?>" title="<?php echo $FilterName; ?>" class="ActionButton Filter">Maak nu een afspraak</a>
										</div>
									</div>
								</li>	
								...
								$AdsQuery = "SELECT * FROM `CMS_PAGES` WHERE ID = '3' ORDER BY `ID` ASC LIMIT 1";
								$AdsResult = @ $Mysqli->query($AdsQuery);
								...
								if($AdsResult->num_rows == 1){
									...
									echo <<<END
										<li class="FilterLi">
											<a class="FilterA" href="$OptionUrl" title="$OptionName">Bekijk alle diensten</a>
										</li>
END;
								}
...
<!--<div class="autowide">
	<div class="module">
    <p><center><img class="partnerlogo" src="http://192.168.33.10/hulpstation.nl/assets/img/partners/2.png" alt="" /></center></p>
	</div>
	<div class="module">
    <p><center><img class="partnerlogo" src="http://192.168.33.10/hulpstation.nl/assets/img/partners/general.png" alt="" /></center></p>
	</div>
	<div class="module">
    <p><center><img class="partnerlogo"  src="http://192.168.33.10/hulpstation.nl/assets/img/partners/coolblue.png" alt="" /></center></p>
	</div>
	<div class="module">
    <p><center><img class="partnerlogo" src="http://192.168.33.10/hulpstation.nl/assets/img/partners/eset.png" alt="" /></center></p>
	</div>
</div>-->
