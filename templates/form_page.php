					...
					<div class="BorderSpace Wysiwyg">
						...
						<fieldset class="FormWrap Form">
							<form name="Request" method="POST">
								<input class="Field" type="hidden" value="<?php echo $PageID; ?>" attrType="" AttrValidate="true" name="ID"/>
									...
									<div class="Col OneOfTwo">
										<div class="BorderSpace">
											<label class="FieldLabel">
												<input class="Field Input" type="text" value="<?php echo CleanTitle(strtolower($PageTitle)); ?>" attrValue="Probleem" attrType="Name" AttrValidate="true" name="Aanvraag"/>
											</label>
										</div>
									</div>
								</div>
